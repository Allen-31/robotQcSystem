...
import { THEME_CHANGED_EVENT, getStoredThemeMode, resolveThemeMode, setStoredThemeMode, type ThemeMode } from './themeStore';
...
export function useTheme() {
  ...
  useEffect(() => {
    ...
    const onThemeChanged = () => setThemeModeState(getStoredThemeMode());
